class ApiData_v1:
    ...
    api_key = 'wNxRewGJZM2xe0xZgePsPB3BwOUjpsenRWXiIlQfEAsnOqR7NtkxtEeYMc41'  # Введите ваш api_key
...
class ApiData_v2:
    ...
    api_key = 'wNxRewGJZM2xe0xZgePsPB3BwOUjpsenRWXiIlQfEAsnOqR7NtkxtEeYMc41'
